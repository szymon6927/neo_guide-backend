...
class TestPsalmListViewCardColorFilter:
    ...
    def test_card_color_filter_with_one_color(self, api_client, card_color, different_card_color, psalms_number):
        ...
        response = api_client.get(reverse('v1-psalms:psalm-list'), {'card_color': card_color})
    ...
    def test_card_color_filter_with_one_wrong_color(self, api_client):
        response = api_client.get(reverse('v1-psalms:psalm-list'), {'card_color': 'test'})
    ...
    def test_card_color_filter_multiple_colors(self, api_client, card_colors, expected_result_number):
        assert Psalm.objects.all().count() == 25

        response = api_client.get(reverse('v1-psalms:psalm-list'), {'card_color': card_colors})
    ...
    def test_card_color_filter_multiple_colors_with_wrong_color(self, api_client, card_colors):
...
class TestPsalmListViewPsalmTypeFilter:
    ...
    def test_psalm_type_filter_with_one_type(self, api_client, psalm_type, different_psalm_type, psalms_number):
        PsalmFactory.create_batch(psalms_number, type=psalm_type)
        PsalmFactory.create_batch(psalms_number, type=different_psalm_type)

        response = api_client.get(reverse('v1-psalms:psalm-list'), {'type': psalm_type})
        assert Psalm.objects.all().count() == 2 * psalms_number
        assert response.status_code == status.HTTP_200_OK
        assert len(response.data['results']) == psalms_number
        assert response.data['count'] == psalms_number

    def test_psalm_type_filter_with_one_wrong_type(self, api_client):
        response = api_client.get(reverse('v1-psalms:psalm-list'), {'type': 'test'})
    ...
    def test_psalm_type_filter_multiple_types(self, api_client, psalm_types, expected_result_number):
        assert Psalm.objects.all().count() == 35

        response = api_client.get(reverse('v1-psalms:psalm-list'), {'type': psalm_types})
    ...
    def test_psalm_type_filter_multiple_colors_with_wrong_color(self, api_client, psalm_types, expected_result_number):
        assert Psalm.objects.all().count() == 35
...
class TestPsalmListViewLiturgicalPeriodFilter:
    ...
    def test_liturgical_period_filter_with_one_type(
        self, api_client, liturgical_period, different_liturgical_period, psalms_number
    ):
        ...
        response = api_client.get(reverse('v1-psalms:psalm-list'), {'liturgical_period': liturgical_period})
        assert Psalm.objects.all().count() == 2 * psalms_number
        assert response.status_code == status.HTTP_200_OK
        assert len(response.data['results']) == psalms_number
        assert response.data['count'] == psalms_number

    def test_liturgical_period_filter_with_one_wrong_type(self, api_client):
        response = api_client.get(reverse('v1-psalms:psalm-list'), {'liturgical_period': 'test'})
    ...
    def test_liturgical_period_filter_multiple_types(self, api_client, liturgical_periods, expected_result_number):
        assert Psalm.objects.all().count() == 20

        response = api_client.get(reverse('v1-psalms:psalm-list'), {'liturgical_period': liturgical_periods})
    ...
    def test_liturgical_period_filter_multiple_colors_with_wrong_color(self, api_client, liturgical_periods):
        assert Psalm.objects.all().count() == 20
...
class TestPsalmListViewNeoStageFilter:
    ...
    def test_neo_stage_filter_with_one_type(self, api_client, neo_stage, different_neo_stage, psalms_number):
        ...
        response = api_client.get(reverse('v1-psalms:psalm-list'), {'neo_stage': neo_stage})
        assert Psalm.objects.all().count() == 2 * psalms_number
        assert response.status_code == status.HTTP_200_OK
        assert len(response.data['results']) == psalms_number
        assert response.data['count'] == psalms_number

    def test_neo_stage_filter_with_one_wrong_type(self, api_client):
        response = api_client.get(reverse('v1-psalms:psalm-list'), {'neo_stage': 'test'})
    ...
    def test_neo_stage_filter_multiple_types(self, api_client, neo_stages, expected_result_number):
        assert Psalm.objects.all().count() == 45

        response = api_client.get(reverse('v1-psalms:psalm-list'), {'neo_stage': neo_stages})
    ...
    def test_neo_stage_filter_multiple_colors_with_wrong_color(self, api_client, neo_stages):
        assert Psalm.objects.all().count() == 45
...
class TestPsalmListViewWithMultipleFilters:
    def test_multiple_filters_scenario_1(self, api_client):
    ...
    def test_multiple_filters_scenario_2(self, api_client):
        PsalmFactory.create_batch(
            5,
            card_color=CardColorChoices.WHITE.value,
            type=PsalmTypeChoices.PEACE_SIGN.value,
    ...
    def test_multiple_filters_scenario_3(self, api_client):
